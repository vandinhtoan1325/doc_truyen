...
public class ListComicBxhAdapter extends RecyclerView.Adapter<ListComicBxhAdapter.MyViewHolder> {

    private ArrayList<Comic> listComic;
    private Context context;
    private ListComicBxhAdapter.onClickTruyenBxh onClickTruyen;

    public ListComicBxhAdapter(ArrayList<Comic> movieList, Context context, ListComicBxhAdapter.onClickTruyenBxh onClickTruyen) {
    ...
    @NonNull
    @Override
    public ListComicBxhAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_bxh, parent, false);

        return new ListComicBxhAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull ListComicBxhAdapter.MyViewHolder holder, int position) {
...
//            }
        ...
        holder.thumbnail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                onClickTruyen.clickTruyenBxh(comic);
            }
        });
    }
    ...
    public interface onClickTruyenBxh {
        void clickTruyenBxh(Comic comic);
    }
}
